...
<body>
 ...
 <div  class = "frm-1">
  ...
  <tr>
    ...
    $queryId=mysqli_query($connectId,"select applyjob.applyjob_id,vacancy.jobtitle,user.fullname,applyjob.status from  applyjob,user,vacancy where applyjob.usr_id=user.usr_id and applyjob.job_id=vacancy.job_id and vacancy.comp_id='$cid' and applyjob.status is null" );
